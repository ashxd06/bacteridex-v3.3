...
export default function BuscarPage() {
  ...
  const iconoPara = (tipo: string) =>
    tipo === "organismo" ? "🧫" : tipo === "prueba" ? "🧪" : tipo === "procedimiento" ? "📋" : "🧫";
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <input
        ...
        className="focus-ring w-full rounded-xl border border-base-600 bg-base-800 px-4 py-3 text-base placeholder:text-mist-400"
      />
