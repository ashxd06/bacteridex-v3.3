...
const enlaces: { href: string; label: string; icon: LucideIcon }[] = [
  ...
  { href: "/resultados", label: "Resultados", icon: ClipboardList },
  { href: "/registros", label: "Registros", icon: History },
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-base-700/80 bg-base-900/85 backdrop-blur print:hidden">
